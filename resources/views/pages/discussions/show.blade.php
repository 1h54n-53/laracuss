        ...
        <div class="container">
            <div class="mb-5">
                <div class="d-flex align-items-center">
                    <div class="d-flex">
                        <div class="fs-2 fw-bold color-gray me-2 mb-0">Discussion</div>
                    ...
                    <div class="card card-discussion mb-5">
                        <div class="row">
                            <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                <a href="#">
                                    <img src="{{ url('assets/like.png') }}" alt="Like" class="Like-icon mb-1">
                                </a>
                                ...
                                <div class="row align-items-start justify-content-between">
                                    ...
                                    <div class="col-5 col-lg-3 d-flex">
                                        <a href="#" class="card-discussions-show-avatar-wrapper flex-shrink-0 rounded-circle overflow-hidden me-1">
                                            <img src="{{ url('assets/avatar.png') }}" alt="" class="avatar">
                                        </a>
...
<script>
    $(document).ready(function() {
        $('#share-discussions').click(function(){
            ...
            alertContainer.first().text('Link to this disscussion copied succsesfully');
        })
    })
</script>
@endsection