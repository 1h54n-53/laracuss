            ...
            <div class="row pt-5 justify-content-center">
                ...
                <div class="col-12 col-lg-3 h-100">
                    <a href="#" class="nav-link mb-5 text-center">
                        <img class="h-32px" src="{{ url('assets/logo-blue.png') }}" alt="Laracuss logo">
                    </a>
                    <div class="card mb-5">
                        <form action="">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text bg-white border-start-0 pe-auto @error('password') border-danger rounded-end @enderror">
                                        <a href="javascript:;" id="password-toggle">
                                            <img src="{{ url('assets/eye-slash.png') }}" alt="Password toggle" id="password-toggle-img">
                                        </a>
                                    </span>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('#password-toggle').on('click', function() {
            ...
            if (isPasswordRevealed) {
                $('#password-toggle-img').attr('src', "{{ url('assets/eye.png') }}");
                $('#password').attr('type', 'text');
            }
            else {
                $('#password-toggle-img').attr('src', "{{ url('assets/eye-slash.png') }}");
